...
public class NotasController {
    ...
    public MessageResponseDTO salvarNotasDisciplina (@PathVariable Long idAluno, @RequestBody Notas notas) throws NotFoundException, DuplicateException {
    ...
    public MessageResponseDTO modificarNotasDisciplina (@PathVariable Long idAluno, @RequestBody Notas notas) throws NotFoundException {
